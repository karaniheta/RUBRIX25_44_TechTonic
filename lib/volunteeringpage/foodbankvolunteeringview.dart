                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                IconButton(onPressed: opportunities[index].reference.delete, icon: Icon(Icons.delete), color: AppColors.navbarcolorbg,)
                              ],
                            ),
                            ...
                            Container(
                              ...
                              child: Text('Vacancies : ${opportunity['vacancies'].toString()}',
                              style: TextStyle(
                                fontFamily: 'interR',
                                color: AppColors.navbarcolorbg,
                                fontSize: 14
